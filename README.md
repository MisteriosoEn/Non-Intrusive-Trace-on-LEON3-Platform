...
Some code was supported in Vivado 2017.2 but not supported in the later version of Vivado (the design tool will report a syntax error), but it just need some simple changes to adapt to them.
